...
export const addDeposit = async (req, res) => {
    ...
    try {
        ...
        const session = await stripe.checkout.sessions.create({
            ...
            mode: "payment",
            success_url: `http://localhost:3000/taskSubDetailed/${taskId}?session_id={CHECKOUT_SESSION_ID}`,
...
export const createAddWalletStripe = async (req, res) => {
    try {
        ...
        const session = await stripe.checkout.sessions.create({
            ...
            success_url: `http://localhost:3000/user/deposit?session_id={CHECKOUT_SESSION_ID}`,
            cancel_url: `http://localhost:3000/user/deposit`,
        });
